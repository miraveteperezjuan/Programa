...
public class RegionDaoImpList implements RegionDao { //los metodos ya estan hecho y lo que hay que hacer es implementar esos metodos o heredar esos metodos
	...
	private List<Region> lista; //esto se inicia a null y lo que hay que hacer es arrancar la lista que es lo de abajo.
	...
	*/
	...
	@Override
	public List<Region> buscarNombreContains(String cadena) {
